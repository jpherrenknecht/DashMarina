...
( function () {
    ...
    function commonTableLines(r) {
		...
		if ( r.curr.twa == entTwa ) {
			...
			var twaMax = twaMin - 1 ;
			var popUpTwaHdg = "Tip pour les ajustements de TWA / HDG :\nOn navigue " + amure + " amure, à TWA fixe = " + Math.abs(r.curr.twa) +"\nLe passage au cap fixe HDG = " + hdgMin + " donnerait une TWA de = " + Math.abs(twaMin) + "\nPour un cap = " + hdgMax + " la TWA deviendrait = " + Math.abs(twaMax);
		} else if ( r.curr.heading == entHdg ) {
			var twaMin = entTwa;
			var twaMax = entTwa + 1;
			var hdgMin = Math.round((r.curr.heading - ( entTwa - r.curr.twa ))*100)/100;
			var hdgMax = hdgMin - 1;			
			var popUpTwaHdg = "Tip pour les ajustements de TWA / HDG :\nOn navigue " + amure + " amure, au cap fixe HDG = " + r.curr.heading +"\nLe passage à TWA fixe = " + twaMin + " donnerait un cap HDG = " + hdgMin + "\nPour une une TWA = " + twaMax + " le cap deviendrait = " + hdgMax;
		} else {
